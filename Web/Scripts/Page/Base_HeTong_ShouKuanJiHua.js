...
(function () {
    //需要的列
    var requireColumn = ["jh_htId_bg", "jh_ShouKuanJinE", "jh_ShouKuanRiQi", "jh_DengJiRen"];
    ...
    function createJson() {
        var jsonArray = [];
        jsonArray.push({ itemId: "jh_htId_bg", isNull: false, type: "select", title: "合同或合同变更" }); ///
        ...
        jsonArray.push({ itemId: "jh_ShoukuanShuoMing", type: "ntext", title: "收款说明" });
