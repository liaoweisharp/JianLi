...
public class WebService_HeTong : System.Web.Services.WebService
{
    ...
    [WebMethod]
    public int countQianQi()
    {
        return BLL.HeTong.countQianQi();
    }
    
    [WebMethod]
    public List<DAL.CommClass.XiangMuQianQiWrapper> filterAllXiangMuQianQi(DAL.CommClass.PageClass pageClass)
    {
        return BLL.HeTong.filterAllXiangMuQianQi(pageClass,new string[]{"TabHeTong"});
    }
    ...
    public int updateXiangMuQianQi(DAL.DTO.TabXiangMuQianQi xiangMuQianQi)
    {
        DAL.Base_XiangMuQianQi ins = new DAL.Base_XiangMuQianQi();
        return ins.Updates(new DAL.DTO.TabXiangMuQianQi[] { xiangMuQianQi });
    }
    [WebMethod(Description = "更新发票及收款", EnableSession = true)]
    public int updateFaPiaoJiShouKuan(DAL.DTO.TabFaPiaoJiShouKuanGuanLi obj)
    {
        DAL.Base_FaPiaoJiShouKuan ins = new DAL.Base_FaPiaoJiShouKuan();
        return ins.Updates(new DAL.DTO.TabFaPiaoJiShouKuanGuanLi[] { obj });
    }
    ...
    [WebMethod(Description = "得到执行部门的去重数组", EnableSession = true)]
    public string[] getNameArray()
    {
        DAL.Base_XiangMuQianQi ins = new Base_XiangMuQianQi();
        return ins.getNameArray();
